...
/* JEP-106 code list
 * JEP-106 is a JEDEC standard assigning manufacturer IDs to different manufacturers
 ...
 */
#define ASCII_CODE_FLAG    (1 << 15) /* flag the code as legacy ASCII */

#define JEP106_ARM          0x43B /* ARM Ltd. */
#define JEP106_FREESCALE    0x00e /* Freescale */
#define JEP106_TEXAS        0x017 /* Texas Instruments */
#define JEP106_ATMEL        0x01f /* Atmel */
#define JEP106_STM          0x020 /* STMicroelectronics */
...
#define JEP106_RASPBERRY    0x927 /* Raspberry Pi */
 ...
 */
#define JEP106_ERRATA_STM32WX 0x420
