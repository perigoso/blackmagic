...
static bool kl_gen_command(target *const t, const uint8_t cmd, uint32_t addr, const uint32_t *data, int n_items)
{
	uint8_t fstat;
...
static int kl_gen_flash_write(struct target_flash *const f, target_addr dest, const void *src, size_t len)
{
