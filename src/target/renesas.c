...
static int renesas_flash_erase(struct target_flash *f, target_addr addr, size_t len)
{
	return 0;
}

static int renesas_flash_write(struct target_flash *f, target_addr dest, const void *src, size_t len) {
	return 0;
}

static void renesas_add_flash(target *t, target_addr addr, size_t length, size_t page_size)
{
